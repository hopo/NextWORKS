			...
			<tr>
				...
				<td>
					<form:select path="searchType">
						<form:option value="cust_name">Customer Name</form:option>
						<form:option value="cust_email">Customer Email</form:option>
						<form:option value="cust_main_phone_int">Customer Phone Number</form:option>
						<form:option value="cust_id">Customer ID</form:option>
					</form:select>
				</td>
				<td>
