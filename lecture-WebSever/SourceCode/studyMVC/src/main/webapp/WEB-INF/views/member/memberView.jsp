				...
				<table class="table">
					...
					<tr>
						<th colspan="2" style="text-align: center;">
							...
							<c:url value="/member/memberUpdate.do" var="memberUpdateUrl">
								<c:param name="memId" value="${param.memId}" />
							</c:url>
							<a href="${memberUpdateUrl}">수정</a>

							<c:url value="/member/memberDeleteForm.do" var="memberDeleteUrl">
								<c:param name="memId" value="${param.memId}" />
							</c:url>
							<a href="${memberDeleteUrl}">삭제</a>
						</th>
					</tr>
				</table>
			</blockquote>
