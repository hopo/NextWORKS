...
CREATE TABLE tb_member (
    ...
    CONSTRAINT pk_tb_member PRIMARY KEY (mem_seq_num)
);
...
CREATE TABLE tb_mem_auth (
	mem_seq_no 	NUMBER,
	auth_cd 	VARCHAR2(10),
    CONSTRAINT pk_tb_mem_auth PRIMARY KEY (mem_seq_num, auth_cd),
	CONSTRAINT fk_tb_mem_auth
		FOREIGN KEY (mem_seq_no, auth_cd)
		REFERENCES tb_member(mem_seq_no, auth_cd)
);
