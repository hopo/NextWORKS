...
from departments a
where exists ( select b.emp_name, b.salary, b.department_id
			from employees b
...
--select * from ex3_2 where emp_name like '%10\%%' escape '\' -- escape 활성화
;

-- p122
-- ex1. create table as select 로 테이블 작성 (ex3_6)
